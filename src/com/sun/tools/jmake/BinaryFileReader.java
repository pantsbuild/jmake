...
public class BinaryFileReader {
  ...
  protected long getLong(int bufPos) {
    DataInputStream bufin = new DataInputStream(new ByteArrayInputStream(buf, bufPos, 8));
    try {
  ...
  protected float getFloat(int bufPos) {
    DataInputStream bufin = new DataInputStream(new ByteArrayInputStream(buf, bufPos, 4));
    try {
