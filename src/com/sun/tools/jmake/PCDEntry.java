...
public class PCDEntry {
  ...
  public PCDEntry(String className,
    ...
    this.oldClassFileLastModified = this.newClassFileLastModified = classFileLastModified;
    this.oldClassFileFingerprint = this.newClassFileFingerprint = classFileFingerprint;
